...
<template>
  <div class="container">
    <div class="mt-4">
      ...
      <p class="text-center fs-2 fw-bolder text-danger" v-if="isLoading && !cartsLength">
        購物車目前為空
      </p>
    </div>
